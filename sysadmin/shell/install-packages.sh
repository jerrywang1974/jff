...
###########################################################
# Installation of RoundCube and Redmine requires PostgreSQL service
...
# XXX: Debian Wheezy doesn't package rewritten gitolite 3.x yet, I don't want 2.x.
#i gitolite
i gitweb highlight

# host svn repositories
#       svnserve is preferred than libapache2-svn
